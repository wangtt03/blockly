...
Blockly.Msg.APPLYPOSTURE = "apply posture";  // untranslated
Blockly.Msg.APPLYPOSTURE_TOOLTIP = "NAO goes into the posture.";  // untranslated
...
Blockly.Msg.BLINK_TOOLTIP = "NAO blinks once.";  // untranslated
...
Blockly.Msg.COLOR_BLUE = "Blue";  // untranslated
Blockly.Msg.COLOR_GREEN = "Green";  // untranslated
Blockly.Msg.COLOR_RED = "Red";  // untranslated
...
Blockly.Msg.DISPLAY_SAY = "say";  // untranslated
...
Blockly.Msg.FRAME_ROBOT = "robot";  // untranslated
Blockly.Msg.FRAME_TORSO = "torso";  // untranslated
Blockly.Msg.FRAME_WORLD = "world";  // untranslated
Blockly.Msg.GET = "obtener";
Blockly.Msg.GETLANGUAGE = "get language";  // untranslated
Blockly.Msg.GETLANGUAGE_TOOLTIP = "Get the active language.";  // untranslated
Blockly.Msg.GETSAMPLE_TOOLTIP = "Obtiene la lectura actual del sensor seleccionado";
Blockly.Msg.GETVOLUME = "get volume.";  // untranslated
Blockly.Msg.GETVOLUME_TOOLTIP = "Get the volume.";  // untranslated
...
Blockly.Msg.LEDOFF_TOOLTIP = "Turn the LEDs off.";  // untranslated
Blockly.Msg.LEDRESET = "LED reset";  // untranslated
Blockly.Msg.LEDRESET_TOOLTIP = "Reset the LEDs.";  // untranslated
...
Blockly.Msg.LOOKAT = "look at";  // untranslated
Blockly.Msg.LOOKAT_TOOLTIP = "NAO looks to a given position";  // untranslated
...
Blockly.Msg.PARTIALSTIFFNESSOFF = "stiffness of part off";  // untranslated
Blockly.Msg.PARTIALSTIFFNESSOFF_TOOLTIP = "The stiffness of the given body part is turned off";  // untranslated
Blockly.Msg.PARTIALSTIFFNESSON = "stiffness of part on";  // untranslated
Blockly.Msg.PARTIALSTIFFNESSON_TOOLTIP = "The stiffness of the given body part is turned on";  // untranslated
...
Blockly.Msg.POPUP_NEW_RELEASE = "Versión beta 1.4 <ul class='NonIcon'><li>Crear un programa para el robot real <strong>y</strong> para el robot simulado</li><li>Actualiza blockly para un mejor rendimiento y la función zoom</li></ul>";
...
Blockly.Msg.POPUP_RELEASE = "Versión beta 1.3.2 <ul class='NonIcon'><li>Fix timestamp bug for save program</li></ul>Versión beta 1.3.1 <ul class='NonIcon'><li>!Disponible en Español!</li><li>Fixed bugs</li></ul>Versión beta 1.3.0 <ul class='NonIcon'><li>¡Simula un robot!</li><li>Share your program with a friend</li><li>Update the robots firmware Over-the-Air</li><li>Soporte para cable USB en Chromebooks</li><li>Fixed many more bugs</li></ul></br>";
...
Blockly.Msg.POSTURE_STAND = "Stand";  // untranslated
Blockly.Msg.POSTURE_STANDINIT = "StandInit";  // untranslated
Blockly.Msg.POSTURE_STANDZERO = "StandZero";  // untranslated
...
Blockly.Msg.RANDOMEYES = "Random eyes";  // untranslated
Blockly.Msg.RASTA = "Rasta";  // untranslated
...
Blockly.Msg.SET = "set";
Blockly.Msg.SETEARINTENSITY = "set ear intensity";  // untranslated
Blockly.Msg.SETEARINTENSITY_TOOLTIP = "Set the intensity of the LEDs in the robots ears.";  // untranslated
Blockly.Msg.SETEYECOLOR = "set eye color";  // untranslated
Blockly.Msg.SETEYECOLOR_TOOLTIP = "Set eye color";  // untranslated
Blockly.Msg.SETLANGUAGE = "set language";  // untranslated
Blockly.Msg.SETLANGUAGE_TOOLTIP = "Set the language.";  // untranslated
Blockly.Msg.SETVOLUME = "set volume.";  // untranslated
Blockly.Msg.SETVOLUME_TOOLTIP = "Set the volume.";  // untranslated
...
Blockly.Msg.SITDOWN = "sit down";  // untranslated
Blockly.Msg.SITDOWN_TOOLTIP = "NAO sits down.";  // untranslated
...
Blockly.Msg.STANDUP = "stand up";  // untranslated
Blockly.Msg.STANDUP_TOOLTIP = "NAO stands up.";  // untranslated
...
Blockly.Msg.STIFFNESSOFF = "stiffness off";  // untranslated
Blockly.Msg.STIFFNESSOFF_TOOLTIP = "The stiffness of the whole body is turned off";  // untranslated
Blockly.Msg.STIFFNESSON = "stiffness on";  // untranslated
Blockly.Msg.STIFFNESSON_TOOLTIP = "The stiffness of the whole body is turned on";  // untranslated
Blockly.Msg.STOP = "stop";  // untranslated
Blockly.Msg.STOP_TOOLTIP = "The robot stops all movement.";  // untranslated
...
Blockly.Msg.TAICHI = "tai chi";  // untranslated
Blockly.Msg.TAICHI_TOOLTIP = "NAO performs Tai Chi.";  // untranslated
...
Blockly.Msg.WALK = "walk";  // untranslated
Blockly.Msg.WALKTO = "walk to";  // untranslated
Blockly.Msg.WALKTO_TOOLTIP = "The robot walks to the give position.";  // untranslated
Blockly.Msg.WALK_DISTANCE = "distance m";  // untranslated
Blockly.Msg.WALK_TOOLTIP = "Makes the robot walk a distance.";  // untranslated
Blockly.Msg.WAVE = "wave";  // untranslated
Blockly.Msg.WAVE_TOOLTIP = "NAO waves.";  // untranslated
Blockly.Msg.WIPEFOREHEAD = "wipe forehead";  // untranslated
Blockly.Msg.WIPEFOREHEAD_TOOLTIP = "NAO wipes his forehead.";  // untranslated
Blockly.Msg.YES = "sí";
Blockly.Msg.randomEyes_TOOLTIP = "The Color of the Eyes is changed randomly for a specified amount of time.";  // untranslated
Blockly.Msg.rasta_TOOLTIP = "The Color of the Eyes is changed between green, yellow and red for a specified amount of time.";  // untranslated
