...
Blockly.Msg.ACTOR_HELP = "Dieser Block eignet sich als Platzhalter für ein beliebiges Bauteil, das Strom benötigt, z. B. eine Glühbirne oder eine LED.";
...
Blockly.Msg.BRICKLIGHT_ON_HELP = "Du kannst wählen welche Beleuchtung die Tasten deines EV3 Roboters haben soll. Die Tasten leuchten oder blinken solange bis sie mit einem weiteren Block wieder ausgeschaltet werden.";
...
Blockly.Msg.COLOUR_HELP = "Der Farbsensor erkennt Farben, aber auch die Lichtstärke in der Umgebung oder unterschiedliche Grauwerte von schwarz bis weiß. Damit kann man prima Linienverfolger konstruieren.";
...
Blockly.Msg.CONNECT = "Verbinde mit Robotername";
Blockly.Msg.CONNECTION_RECEIVE_HELP = "Dieser Block wartet auf eine Nachricht aus der Verbindung, die am Eingang Verbindung angegeben wird. Wenn eine Nachricht empfangen wird, gibt dieser Block die Nachricht als Zeichenkette aus";
...
Blockly.Msg.CONNECTION_SEND_HELP = "Du kannst eine Nachricht mit diesem Block versenden. Hänge die Nachricht als Zeichenkette an den Block und vergiß nicht die Verbindung anzugeben, an die die Nachricht geschickt werden soll. ";
Blockly.Msg.CONNECTION_SEND_HELPURL = "https://mp-devel.iais.fraunhofer.de/wiki/x/CwA-/";  // untranslated
Blockly.Msg.CONNECTION_SEND_TOOLTIP = "Versendet die angehängte Nachricht an einen anderen Roboter.";
Blockly.Msg.CONNECTION_START_HELP = "Mit diesem Block kannst du eine Verbindung per Bluetooth zu einem anderen Roboter aufbauen. Füge den Namen des anderen Roboters als Zeichenkette hinzu. Wenn der andere Roboter die Verbindung bestätigt, gibt dieser Block die Verbindung zurück. Am einfachsten speicherst du diese Verbindung in einer Variable vom Type »Verbindung«. Über diese verbindung können sich die Roboter untereinander Nachrichten schicken.";
...
Blockly.Msg.CONNECTION_WAIT_HELP = "Mit diesem Block wartet der Roboter auf die Verbindungsanfrage eines anderen Roboters. Dieser Block wird benötigt, wenn ein anderer Roboter versucht eine Verbindung herzustellen, er wartet darauf und bestätigt die Verbindung.";
...
Blockly.Msg.EV3BRICK_HELP = "Das Gehirn deines Roboters ,-).<br>An diesen EV3 Stein kannst Sensoren an den Anschlüssen Sensor 1 - 4 und Motoren an den Anschlüssen Motor A - D anschließen. Raddurchmesser und Spurbreite sind wichtig, damit der Roboter bei allen »Fahr«-Blöcken richtig gesteuert wird.";
...
Blockly.Msg.GYRO_HELP = "Der Kreiselsensor kann Drehbewegungen messen. Je nachdem wie er auf dem Roboter angebracht wird, erkennt er, um wieviel Grad sich der Roboter dreht oder auch ob der Roboter in Schräglage ist, z. B. eine Steigung hinauffährt.";
...
Blockly.Msg.INFRARED_HELP = "Der Infrarotsensor kann mit infrarotem Licht Abstände erkennen. Mit dem IR Beacon, der selber infrarotes Licht ausstrahlt, kann man den Roboter fernsteuern. Der Infrarotsensor empfängt dabei die Signale des IR-Beacon.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Extrahiere und entfernt ds #1te Element vom Ende der Liste.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP = "Erstellt vom angegebenen Bereich eine Kopie der Liste.";
Blockly.Msg.LISTS_INDEX_OF_FIRST = "suche ersten Treffer";
...
Blockly.Msg.LISTS_INDEX_OF_LAST = "suche letzten Treffer";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Fügt ein Element am Anfang der Liste ein.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Fügt ein Element an der angegebenen Stelle in die Liste ein. #1 ist das letzte Element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Fügt ein Element an der angegebenen Stelle in die Liste ein.  #1 ist das erste Element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "Fügt ein Element am Ende der Liste ein.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Fügt ein Element an einer zufälligen Stelle in die Liste ein.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM = "Gibt einen Zufallswert aus der Liste zurück.";
...
Blockly.Msg.MESSAGE_RESTART_ROBOT = "Dein Roboter kann die neue Firmware nur dann nutzen, wenn Du ihn neu startest. Schalte den Roboter aus und wieder ein und verbinde ihn danach mit dem Open Roberta Lab.";
...
Blockly.Msg.MOTOR_BIG_HELP = "Der große Motor ist ein sog. Servomotor. Bei ihm kann man die Drehgeschwindigkeit und die Beschleunigung kontrollieren, da er einen eingebauten Drehsensor hat. Für die Programmierung mit den »Fahr«-Blöcken ist es wichtig zu wissen, wie er am Roboter angebracht ist.";
...
Blockly.Msg.MOTOR_MIDDLE_HELP = "Der mittlere Motor ist ein sog. Servomotor. Bei ihm kann man die Drehgeschwindigkeit und die Beschleunigung kontrollieren, da er einen eingebauten Drehsensor hat. Für die Programmierung ist es wichtig zu wissen, in welche Richtung er sich drehen soll.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_BACK = "zurück";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Gibt den zweiten Wert zurück, wenn der erste Wert wahr (true) ist.";
...
Blockly.Msg.RECEIVED_DATA = "Empfange Nachricht";
...
Blockly.Msg.SEND_DATA = "Sende Nachricht";
...
Blockly.Msg.SENSOR_GET_SAMPLE_HELP = "Hilfe";
...
Blockly.Msg.TEXT_CHARAT_FIRST = "Nimm ersten Buchstabe";
Blockly.Msg.TEXT_CHARAT_FROM_END = "Nimm #te Buchstaben von hinten";
Blockly.Msg.TEXT_CHARAT_FROM_START = "Nimm Buchstaben #ten";
...
Blockly.Msg.TEXT_CHARAT_LAST = "Nimm letzten Buchstabe";
Blockly.Msg.TEXT_CHARAT_RANDOM = "Nimm zufälligen Buchstabe";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "Suche ersten Treffer des Begriff";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "Suche letzten Treffer des Begriff";
Blockly.Msg.TEXT_INDEXOF_TAIL = "";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Findet den ersten / letzten Treffer eines Suchbegriffes in einem Text. Gibt die Position des Begriffes oder 0 zurück.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "Gibt den Inhalt einer Variable aus.";
...
Blockly.Msg.ULTRASONIC_HELP = "Der Ultraschallsensor kann mit den Ultraschallwellen messen, wie weit ein Gegenstand vom Sensor entfernt ist. Damit kann man besonders gut Roboter konstruieren, die Hindernisse vermeiden.";
...
Blockly.Msg.WAIT_FOR_CONNECTION = "Warte auf Verbindung";
Blockly.Msg.WAIT_FOR_HELP = "Hilfe";
