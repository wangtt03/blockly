...
Blockly.Blocks['naoActions_partialStiffnessOn'] = {
	    init : function() {
	        this.setColour(Blockly.CAT_ACTION_RGB);
	        var dropdown = new Blockly.FieldDropdown([ [ Blockly.Msg.NAO_BODY_ARM, 'ARM' ], [ Blockly.Msg.NAO_BODY_LARM, 'LARM' ], [ Blockly.Msg.NAO_BODY_RARM, 'RARM' ] ]);
...
Blockly.Blocks['naoActions_turn'] = {
	    init : function() {
	        this.setColour(Blockly.CAT_ACTION_RGB);
	        var dropdown = new Blockly.FieldDropdown([ [ Blockly.Msg.NAO_TURN_LEFT, 'LEFT' ], [ Blockly.Msg.NAO_TURN_RIGHT, 'RIGHT' ] ]);
...
Blockly.Blocks['naoActions_setLanguage'] = {
		    init : function() {
		        this.setColour(Blockly.CAT_ACTION_RGB);
		        var dropdown = new Blockly.FieldDropdown([ [ Blockly.Msg.NAO_LANGUAGE_GERMAN, 'GERMAN' ], [ Blockly.Msg.NAO_LANGUAGE_ENGLISH, 'ENGLISH' ], [ Blockly.Msg.NAO_LANGUAGE_FRENCH, 'FRENCH' ] ]);
...
Blockly.Blocks['naoActions_setEyeColor'] = {
		    init : function() {
		        this.setColour(Blockly.CAT_ACTION_RGB);
		        var dropdown = new Blockly.FieldDropdown([ [ Blockly.Msg.NAO_COLOR_GREEN, 'GREEN' ], [ Blockly.Msg.NAO_COLOR_BLUE, 'BLUE' ], [ Blockly.Msg.NAO_COLOR_RED, 'RED' ] ]);
