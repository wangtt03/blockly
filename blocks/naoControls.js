...
/**
 * @fileoverview Control blocks for NAO.
 * @requires Blockly.Blocks
 * @author janis.mohr@iais.fraunhofer.de (Janis Mohr)
 */

'use strict';

goog.provide('Blockly.Blocks.naoControls');
...
// not used.
Blockly.Blocks['naoControls_start'] = {
    /**
     ...
     * task see {@link Block.naoControls_activity}.
     * 
     * @constructs naoControls_start
     * @this.Blockly.Block
     * @returns immediately
     * @see {@link naoControls_activity}
     * @memberof Block
     */
 ...
 * 
 * @constructs naoControls_wait_for
 * @param {Boolean} -
 *            sensor condition.
...
Blockly.Blocks['naoControls_wait_for'] = {
    ...
    updateShape_ : function(num) {
        ...
        if (num == 1) {
            ...
            var s = this.workspace.newBlock('naoSensors_getSample');
            s.initSvg();
            s.render();
