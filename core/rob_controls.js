 ...
 * @private
 */
Blockly.RobControls.prototype.PATH_RUNONBRICK_ = 'M15.396 23.433c2.641-2.574 6.604-6.433 6.604-6.433s-3.963-3.859-6.604-6.433 '
...
Blockly.RobControls.prototype.PATH_SIMPAUSE_ = 'M12 10c-1.104 0-2 .896-2 2v8c0 1.104.896 2 2 2s2-.896 2-2v-8c0-1.104-.896-2 '
        + '-2-2zM19 10c-1.104 0-2 .896-2 2v8c0 1.104.896 2 2 2s2-.896 2-2v-8c0-1.104 ' + '-.896-2-2-2z';
Blockly.RobControls.prototype.PATH_SIMSTEP_ = 'M23 21.5v-10c0-1.104-0.895-2-2-2s-2 0.896-2 2v10c0 1.104 0.896 2 2 2 1.105 '
        + '0 2-0.896 2-2zM12.396 22.934c2.641-2.575 6.604-6.434 6.604-6.434s-3.963 '
        + '-3.859-6.604-6.433c-0.363-0.349-0.853-0.567-1.396-0.567-1.104 0-2 0.896-2 ' + '2v10c0 1.104 0.896 2 2 2 0.543 0 1.033-0.218 1.396-0.566z';
Blockly.RobControls.prototype.PATH_SAVEPROGRAM_ = 'M21 13 l-.351.015c-.825-2.377-3.062-4.015-5.649-4.015-3.309 0-6 2.691-6 '
        ...
        + '-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-1.293-1.293v4.586h4c2.757 ' + '0 5-2.243 5-5s-2.243-5-5-5z';
Blockly.RobControls.prototype.PATH_ZOOM_ = 'M17 8c-3.859 0-7 3.141-7 7 0 .763.127 1.495.354 2.183l-.749.75-.511.512 '
        + '-1.008 1.045c-.562.557-.891 1.345-.891 2.185 0 1.727 1.404 3.131 3.13 ' + '3.131.757 0 1.504-.278 2.104-.784l.064-.055.061-.061 1.512-1.51.75-.749 '
        ...
        + '1.794-4 4s1.795 4 4 4 4-1.794 4-4-1.795-4-4-4zm0 7c-1.656 0-3-1.344-3-3s ' + '1.344-3 3-3 3 1.344 3 3-1.344 3-3 3z';
Blockly.RobControls.prototype.PATH_ZOOMIN_ = 'M18 16h-2v-2c0-.276-.224-.5-.5-.5s-.5.224-.5.5v2h-2c-.276 0-.5.224-.5.5 '
        + 's.224.5.5.5h2v2c0 .276.224.5.5.5s.5-.224.5-.5v-2h2c.276 0 .5-.224.5-.5s '
        + '-.224-.5-.5-.5zM23.432 19.97l-.536-.537-.749-.75c.227-.688.354-1.42.354 ' + '-2.183 0-3.859-3.141-7-7-7s-7 3.141-7 7 3.141 7 7 7c.763 0 1.496-.127 '
        + '2.184-.354l.75.749 1.512 1.51.061.061.064.055c.601.506 1.348.784 2.104.784 '
        + '1.726 0 3.13-1.404 3.13-3.131 0-.84-.328-1.628-.924-2.218l-.95-.986zm ' + '-12.932-3.47c0-2.757 2.243-5 5-5s5 2.243 5 5-2.243 5-5 5-5-2.243-5-5z';
Blockly.RobControls.prototype.PATH_ZOOMOUT_ = 'M18 16h-5c-.276 0-.5.224-.5.5s.224.5.5.5h5c.276 0 .5-.224.5-.5s-.224-.5-.5 '
        ...
        + '0 3.13-1.404 3.13-3.131 0-.84-.328-1.628-.924-2.218zm-13.881-4.456c0-2.757 ' + '2.243-5 5-5s5 2.243 5 5-2.243 5-5 5-5-2.243-5-5z';
Blockly.RobControls.prototype.PATH_ZOOMRESET_ = 'M15 10.1C15.1 9 13.3 8.7 13 9.8 12.8 10.2 13.4 11.5 12.7 11.3 11.6 10.2 '
        ...
        + '14.7 23.1 13 22 13 21.6 13 20 13.2 20.9 12.5 21.9 11.5 22.9 10.5 23.9 9.5 ' + '24.4 8.6 23.1 7.5 22.3 8.3L22.3 8.3 22.3 8.3z';
Blockly.RobControls.prototype.PATH_SHOWCODE_ = 'M12.671 21.5c-.512 0-1.023-.195-1.414-.586l-4.414-4.414 4.414-4.414c.781 '
        ...
        + '-1.585-1.586c-.781-.781-.781-2.047 0-2.828.779-.781 2.047-.781 2.828 0 ' + 'l4.414 4.414-4.414 4.414c-.39.391-.902.586-1.414.586z';
/**
...
Blockly.RobControls.prototype.buttons = [];
/**
...
Blockly.RobControls.prototype.createButton_ = function(pathD, posX, posY, tooltip) {
    ...
    rect.tooltip = Blockly.Msg[tooltip];
    ...
    path.tooltip = Blockly.Msg[tooltip];
...
/**
 * Dispose of this button controls. Unlink from all DOM elements to prevent
 * memory leaks.
 */
...
Blockly.RobControls.prototype.refreshTooltips = function(robotRealName) {
    for (var i = 0; i < this.buttons.length; i++) {
        var value = Blockly.Msg[this.buttons[i].tooltip];
        if (value.indexOf("$") >= 0) {
            value = value.replace("$", robotRealName);
        }
        this.buttons[i].childNodes[0].tooltip = value;
        this.buttons[i].childNodes[1].tooltip = value;
    }
};
